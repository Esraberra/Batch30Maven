...
public class GoogleWeatherPage {


    WebDriver driver;
    WebDriverWait wait;

public GoogleWeatherPage(WebDriver driver){
    this.driver=driver;
    ...
    @FindBy(xpath = "//div[text()='Kabul ediyorum']")
    public WebElement cookieAccept;

public GoogleWeatherPage forCity(String city) throws InterruptedException {
...
public String getTemperature(){
    ...
    public GoogleWeatherPage useFahrenheit()
    {
    ...
    public GoogleWeatherPage useCelsius()
    {
